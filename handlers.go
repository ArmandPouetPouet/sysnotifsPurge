...
func CheckRatio(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := http.Get("https://search-core-sysnotifs-beta-tsrx3dffhismokydie5vubirdu.eu-west-1.es.amazonaws.com/_cluster/stats")
	if err != nil {
		// handle error
	...
	SetResponse(w, http.StatusOK, s)

}

func searchOldIndex() string {

	resp, err := http.Get("https://search-core-sysnotifs-beta-tsrx3dffhismokydie5vubirdu.eu-west-1.es.amazonaws.com/_stats")
	if err != nil {
		// handle error
...
func purgeIndex(indexName string) {
	...
	req, err := http.NewRequest("DELETE", "https://search-core-sysnotifs-beta-tsrx3dffhismokydie5vubirdu.eu-west-1.es.amazonaws.com/"+indexName, nil)
